...
One great utility of the finite element method is that it is compatible with complex geometric domains and domain decompositions.
...
TetGen is a small tool whose primary purpouse is to perform \textit{constrained Delaunay tetrahedralization}, given a solid boundary and a point cloud on the interior.
This constructs a valid tetrahedral partition intended for finite element solvers. This is efficiently solved in a very robust manner in over 36k lines of C code --- TetGen is part of the geometric backbone of many FEM solvers (references).
% >>>
