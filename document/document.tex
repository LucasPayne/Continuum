...
\subsubsection{The system of conservation laws}
...
really underdetermined because we don't have a specific material in mind.

\subsection{Constitutive relations}
We here investigate possible forms of the
Cauchy stress tensor.
A specification of $\sigma$ is called a \textit{constitutive relation},
...
\subsubsection{The notion of a material point}
The system \eqref{conservation_system} is given in terms of
the material derivative $\frac{D}{Dt} \coloneqq \Part{}{t} + u\cdot\nabla$.
