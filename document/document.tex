...
As a first example, we will derive a finite element method for the Poisson equation.
...
such as in a camera defocus, and in fact many common image processing techniques use diffusion PDEs from physics. We will stick with
...
$A = -\widetilde{\Delta}$.
If we compute these integrals, we will find a very simple closed form for the entries of $\widetilde{\Delta}$.
