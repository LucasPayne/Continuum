...
\subsubsection{The Eulerian perspective for linear momentum conservation}
...
\end{equation}
This simply states that, in the Eulerian perspective,
the only sources of linear momentum at a point are the force and the amount of momentum ``pushed'' into a small control volume around the point.
...
\subsubsection{The Lagrangian perspective for linear momentum conservation}
...
\subsection{Forces on the continuum}
...
of a force $F$ at this point. We next investigate what kinds of forces contribute to $F$, which will lead to the \textit{Cauchy momentum equation},
the typical form of $F = ma$ in continuum mechanics.
