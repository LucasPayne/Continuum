...
\subsection{Velocity}
As in the mechanics of a particle, each component of our state $q \in C$ will have a corresponding velocity $\Part{q}{t}$ which ``generates'' a physical motion of that component.
